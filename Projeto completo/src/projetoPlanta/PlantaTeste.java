...
public class PlantaTeste {
	...
	public static void main(String[] args) {
		...
		System.out.println(
				"\n\t\t-------------------------------------------------------------------------------------------------------------------------------------------------------");
		System.out.println("\n\n\t\t\t\t\t\tE aqui deixamos algumas dicas para você cuidar da sua planta indoor: ");
		System.out.println(
		...
		System.out.println(
				"\n- Para obter um solo bem drenado e bom para o cultivo de grande parte das espécies, misture duas partes de areia para uma parte de terra. "
						+ "\nE evite deixar a terra encharcada, porque a umidade excessiva apodrece as raízes.");
		System.out.println(
